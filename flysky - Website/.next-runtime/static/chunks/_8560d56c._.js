...
;
;
const LiveMap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_context__.A("[project]/src/components/tracking/live-map.tsx [app-client] (ecmascript, next/dynamic entry, async loader)"), {
    loadableGenerated: {
        modules: [
            "[project]/src/components/tracking/live-map.tsx [app-client] (ecmascript, next/dynamic entry)"
        ]
    },
    ssr: false,
    loading: ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "flex items-center justify-center h-full min-h-[420px] bg-slate-900 rounded-xl border border-slate-800",
...
function distanceNmBetweenPoints(lat1, lng1, lat2, lng2) {
...
function TrackingPage() {
    ...
    const [airportsByIcao, setAirportsByIcao] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [selected, setSelected] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [aircraftPhotoUrl, setAircraftPhotoUrl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [aircraftPhotoLoading, setAircraftPhotoLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const mapTheme = theme === 'light' ? 'light' : 'dark';
    var _flights_find;
    const selectedFlight = selected ? (_flights_find = flights.find((flight)=>flight.id === selected)) !== null && _flights_find !== void 0 ? _flights_find : null : null;
    ...
    const remainingNm = selectedFlight && arrAirport ? Math.max(0, Math.round(distanceNmBetweenPoints(selectedFlight.lat, selectedFlight.lng, arrAirport.lat, arrAirport.lng))) : null;
    const pilotName = selectedFlight ? "".concat(selectedFlight.pilot.firstName, " ").concat(selectedFlight.pilot.lastName) : '';
    const fetchFlights = async ()=>{
        const liveRes = await fetch('/api/tracking/live');
        if (liveRes.ok) {
            const liveFlights = await liveRes.json();
            setFlights(liveFlights);
            const icaos = Array.from(new Set(liveFlights.flatMap((flight)=>[
                    flight.depIcao,
                    flight.arrIcao
                ]).map((icao)=>icao.trim().toUpperCase()).filter((icao)=>icao.length === 4)));
            if (icaos.length > 0) {
                const airportsRes = await fetch("/api/tracking/airports?icao=".concat(encodeURIComponent(icaos.join(','))));
                if (airportsRes.ok) {
                    const airports = await airportsRes.json();
                    const next = airports.reduce((acc, airport)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TrackingPage.useEffect": ()=>{
            ...
            const loadAircraftPhoto = {
                "TrackingPage.useEffect.loadAircraftPhoto": async ()=>{
                    setAircraftPhotoLoading(true);
                    try {
                        const response = await fetch("/api/tracking/aircraft-photo?callsign=".concat(encodeURIComponent(selectedFlight.callsign), "&depIcao=").concat(encodeURIComponent(selectedFlight.depIcao), "&arrIcao=").concat(encodeURIComponent(selectedFlight.arrIcao)), {
                        ...
                        var _payload_photoUrl;
                        setAircraftPhotoUrl((_payload_photoUrl = payload.photoUrl) !== null && _payload_photoUrl !== void 0 ? _payload_photoUrl : null);
                    } catch (e) {
            ...
            }["TrackingPage.useEffect.loadAircraftPhoto"];
            loadAircraftPhoto();
            return ({
                "TrackingPage.useEffect": ()=>{
                    controller.abort();
        ...
        selectedFlight === null || selectedFlight === void 0 ? void 0 : selectedFlight.id,
        selectedFlight === null || selectedFlight === void 0 ? void 0 : selectedFlight.callsign,
        selectedFlight === null || selectedFlight === void 0 ? void 0 : selectedFlight.depIcao,
        selectedFlight === null || selectedFlight === void 0 ? void 0 : selectedFlight.arrIcao
    ]);
    if (!mounted) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "h-[calc(100dvh-8rem)] sm:h-[calc(100dvh-9rem)] lg:h-[calc(100dvh-10rem)] overflow-hidden",
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "h-full min-h-[420px] bg-slate-900 rounded-xl border border-slate-800"
            }, void 0, false, {
                fileName: "[project]/src/app/dashboard/tracking/page.tsx",
                lineNumber: 154,
                columnNumber: 9
    ...
    var _depAirport_name, _arrAirport_name, _selectedFlight_aircraftType, _selectedFlight_aircraftType1;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "h-[calc(100dvh-8rem)] sm:h-[calc(100dvh-9rem)] lg:h-[calc(100dvh-10rem)] overflow-hidden",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "relative h-full",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(LiveMap, {
                    flights: flights,
                ...
                selectedFlight ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
                    className: "absolute top-4 left-4 z-20 w-[340px] max-w-[calc(100%-2rem)] max-h-[calc(100%-2rem)] overflow-y-auto rounded-2xl border border-white/35 bg-gradient-to-br from-sky-600/90 via-cyan-500/88 to-teal-400/88 text-slate-900 backdrop-blur-xl shadow-2xl shadow-sky-900/35",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "relative h-44 overflow-hidden rounded-t-2xl border-b border-white/35 bg-sky-600/30",
                            children: [
                                aircraftPhotoUrl ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                    src: aircraftPhotoUrl,
                                    alt: "".concat(selectedFlight.callsign, " aircraft"),
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "absolute inset-0 bg-gradient-to-t from-sky-950/40 via-transparent to-sky-100/10"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/dashboard/tracking/page.tsx",
                                    lineNumber: 184,
                                    columnNumber: 15
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "absolute left-3 top-3 z-10 inline-flex items-center gap-1.5 rounded-lg border border-white/35 bg-white/20 px-2.5 py-1 text-[11px] font-semibold text-white/95 backdrop-blur",
                                    children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    className: "absolute top-3 right-3 z-10 inline-flex items-center justify-center rounded-full border border-white/35 bg-white/20 p-2 text-white/95 backdrop-blur hover:bg-white/30",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "rounded-xl border border-white/30 bg-white/55 px-3 py-2 backdrop-blur-sm",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "text-[10px] font-semibold uppercase tracking-wide text-sky-700/90",
                                                    children: "Departure"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/dashboard/tracking/page.tsx",
                                                    lineNumber: 203,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "text-lg font-extrabold leading-none text-slate-900",
                                                    children: selectedFlight.depIcao
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/dashboard/tracking/page.tsx",
                                                    lineNumber: 204,
                                                    columnNumber: 19
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "truncate text-xs text-slate-700/85",
                                                    children: (_depAirport_name = depAirport === null || depAirport === void 0 ? void 0 : depAirport.name) !== null && _depAirport_name !== void 0 ? _depAirport_name : 'Unknown airport'
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/dashboard/tracking/page.tsx",
                                                    lineNumber: 205,
                                                    columnNumber: 19
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "rounded-xl border border-white/30 bg-white/55 px-3 py-2 text-right backdrop-blur-sm",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "text-[10px] font-semibold uppercase tracking-wide text-emerald-700/90",
                                                    children: "Arrival"
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/dashboard/tracking/page.tsx",
                                                    lineNumber: 208,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "text-lg font-extrabold leading-none text-slate-900",
                                                    children: selectedFlight.arrIcao
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/dashboard/tracking/page.tsx",
                                                    lineNumber: 209,
                                                    columnNumber: 19
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "truncate text-xs text-slate-700/85",
                                                    children: (_arrAirport_name = arrAirport === null || arrAirport === void 0 ? void 0 : arrAirport.name) !== null && _arrAirport_name !== void 0 ? _arrAirport_name : 'Unknown airport'
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/dashboard/tracking/page.tsx",
                                                    lineNumber: 210,
                                                    columnNumber: 19
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "rounded-xl border border-white/30 bg-white/55 p-3 backdrop-blur-sm",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: (_selectedFlight_aircraftType = selectedFlight.aircraftType) !== null && _selectedFlight_aircraftType !== void 0 ? _selectedFlight_aircraftType : 'A/C'
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/dashboard/tracking/page.tsx",
                                                            lineNumber: 218,
                                                            columnNumber: 21
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "mt-2 h-1.5 rounded-full bg-sky-900/20",
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "h-full w-[72%] rounded-full bg-gradient-to-r from-sky-500 via-indigo-500 to-blue-700"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/dashboard/tracking/page.tsx",
                                                lineNumber: 223,
                                                columnNumber: 19
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "mt-2 flex items-center justify-between text-xs text-slate-700",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "font-medium",
                                                    children: remainingNm !== null ? "".concat(remainingNm.toLocaleString(), " NM remaining") : 'Route in progress'
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/dashboard/tracking/page.tsx",
                                                    lineNumber: 226,
                                                    columnNumber: 19
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "flex items-center gap-1.5 text-[10px] font-semibold uppercase tracking-wide text-slate-600",
                                                    children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "mt-1 text-xl font-extrabold leading-none text-slate-900",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "rounded-xl border border-white/30 bg-white/55 px-2.5 py-2 backdrop-blur-sm",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "flex items-center gap-1.5 text-[10px] font-semibold uppercase tracking-wide text-slate-600",
                                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: (_selectedFlight_aircraftType1 = selectedFlight.aircraftType) !== null && _selectedFlight_aircraftType1 !== void 0 ? _selectedFlight_aircraftType1 : 'Unknown type'
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/dashboard/tracking/page.tsx",
                                                    lineNumber: 292,
                                                    columnNumber: 19
...
_s(TrackingPage, "y9I01/Ha8gzC+1m3CJekpayF9Zg=", false, function() {
    return [
...
//# sourceMappingURL=_8560d56c._.js.map