...
"[project]/src/app/airline/info/HomePageForm.module.css [app-client] (css module)", ((__turbopack_context__) => {

__turbopack_context__.v({
  "homePageForm": "HomePageForm-module___XaCpq__homePageForm",
  "inputField": "HomePageForm-module___XaCpq__inputField",
  "preview": "HomePageForm-module___XaCpq__preview",
  "textArea": "HomePageForm-module___XaCpq__textArea",
});
}),
"[project]/src/app/airline/info/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$airline$2f$info$2f$HomePageForm$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__ = __turbopack_context__.i("[project]/src/app/airline/info/HomePageForm.module.css [app-client] (css module)");
;
...
function AirlineInfoPage() {
    ...
    const [bannerLogoFile, setBannerLogoFile] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [logoPreviewUrl, setLogoPreviewUrl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [bannerLogoPreviewUrl, setBannerLogoPreviewUrl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [isCloseModalOpen, setIsCloseModalOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [closePassword, setClosePassword] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const bannerLogoInputRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const { data: airline, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'airline-info'
        ],
        queryFn: {
            "AirlineInfoPage.useQuery": ()=>fetch('/api/airline/info').then({
                    "AirlineInfoPage.useQuery": (r)=>r.json()
                }["AirlineInfoPage.useQuery"])
        }["AirlineInfoPage.useQuery"]
    });
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AirlineInfoPage.useEffect": ()=>{
            setIsMounted(true);
        }
    }["AirlineInfoPage.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    const updateMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "AirlineInfoPage.useMutation[updateMutation]": async ()=>{
                ...
                const data = await response.json().catch({
                    "AirlineInfoPage.useMutation[updateMutation]": ()=>({})
                }["AirlineInfoPage.useMutation[updateMutation]"]);
                if (!response.ok) {
                    const message = typeof (data === null || data === void 0 ? void 0 : data.error) === 'string' ? data.error : 'Failed to update airline info';
        ...
        onSuccess: {
            "AirlineInfoPage.useMutation[updateMutation]": ()=>{
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Airline info updated');
            }
        }["AirlineInfoPage.useMutation[updateMutation]"],
        onError: {
            "AirlineInfoPage.useMutation[updateMutation]": (error)=>{
    ...
    const handleSave = ()=>{
        if (!formData.name.trim()) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Airline name is required');
            return;
        }
    ...
    const handleBannerLogoFileChange = (file)=>{
        if (bannerLogoPreviewUrl) URL.revokeObjectURL(bannerLogoPreviewUrl);
        if (!file) {
            setBannerLogoFile(null);
    ...
    const closeAirlineMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "AirlineInfoPage.useMutation[closeAirlineMutation]": async ()=>{
                const response = await fetch('/api/airline/info', {
                    method: 'DELETE',
                    headers: {
                ...
                const data = await response.json().catch({
                    "AirlineInfoPage.useMutation[closeAirlineMutation]": ()=>({})
                }["AirlineInfoPage.useMutation[closeAirlineMutation]"]);
                if (!response.ok) {
                    const message = typeof (data === null || data === void 0 ? void 0 : data.error) === 'string' ? data.error : 'Failed to close airline';
                    throw new Error(message);
                }
                return data;
            }
        ...
        onSuccess: {
            "AirlineInfoPage.useMutation[closeAirlineMutation]": ()=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Airline closed successfully');
        ...
        onError: {
            "AirlineInfoPage.useMutation[closeAirlineMutation]": (error)=>{
    ...
    if (isLoading) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        fileName: "[project]/src/app/airline/info/page.tsx",
        lineNumber: 175,
        columnNumber: 25
    }, this);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                        ...
                        onChange: (e)=>{
                            ...
                            return handleLogoFileChange((_e_target_files_ = (_e_target_files = e.target.files) === null || _e_target_files === void 0 ? void 0 : _e_target_files[0]) !== null && _e_target_files_ !== void 0 ? _e_target_files_ : null);
                        }
                    }, void 0, false, {
                        fileName: "[project]/src/app/airline/info/page.tsx",
                        lineNumber: 185,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                        ...
                        onChange: (e)=>{
                            var _e_target_files;
                            var _e_target_files_;
                            return handleBannerLogoFileChange((_e_target_files_ = (_e_target_files = e.target.files) === null || _e_target_files === void 0 ? void 0 : _e_target_files[0]) !== null && _e_target_files_ !== void 0 ? _e_target_files_ : null);
                        }
                    }, void 0, false, {
                        fileName: "[project]/src/app/airline/info/page.tsx",
                        lineNumber: 192,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                children: logoPreviewUrl || (airline === null || airline === void 0 ? void 0 : airline.logoUrl) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                    src: logoPreviewUrl || (airline === null || airline === void 0 ? void 0 : airline.logoUrl),
                                    alt: "".concat((airline === null || airline === void 0 ? void 0 : airline.name) || 'Airline', " logo"),
                                    ...
                                    className: "text-sky-500 font-bold text-2xl font-mono",
                                    children: airline === null || airline === void 0 ? void 0 : airline.callsignPrefix
                                }, void 0, false, {
                                    fileName: "[project]/src/app/airline/info/page.tsx",
                                    lineNumber: 210,
                                    columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                        ...
                                        children: airline === null || airline === void 0 ? void 0 : airline.name
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/airline/info/page.tsx",
                                        lineNumber: 214,
                                        columnNumber: 13
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-slate-500 text-sm mt-1 flex items-center gap-2",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "font-mono",
                                                children: (airline === null || airline === void 0 ? void 0 : airline.icaoCode) || (airline === null || airline === void 0 ? void 0 : airline.callsignPrefix)
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/airline/info/page.tsx",
                                                lineNumber: 216,
                                                columnNumber: 15
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                children: [
                                                    "Hub: ",
                                                    airline === null || airline === void 0 ? void 0 : airline.hub
                                                ]
                                            }, void 0, true, {
                                                fileName: "[project]/src/app/airline/info/page.tsx",
                                                lineNumber: 218,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: "Click logo to upload square image (1:1)."
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/airline/info/page.tsx",
                                        lineNumber: 220,
                                        columnNumber: 13
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        type: "button",
                        onClick: ()=>{
                            var _bannerLogoInputRef_current;
                            return (_bannerLogoInputRef_current = bannerLogoInputRef.current) === null || _bannerLogoInputRef_current === void 0 ? void 0 : _bannerLogoInputRef_current.click();
                        },
                        ...
                        children: [
                            bannerLogoPreviewUrl || (airline === null || airline === void 0 ? void 0 : airline.bannerLogoUrl) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                src: bannerLogoPreviewUrl || (airline === null || airline === void 0 ? void 0 : airline.bannerLogoUrl),
                                alt: "".concat((airline === null || airline === void 0 ? void 0 : airline.name) || 'Airline', " wide logo"),
                                ...
                                className: "w-full max-w-[340px] h-20 rounded border border-dashed border-slate-300 dark:border-slate-700 flex items-center justify-center text-sm text-slate-500",
                                children: "Click to upload wide logo"
                            }, void 0, false, {
                                fileName: "[project]/src/app/airline/info/page.tsx",
                                lineNumber: 233,
                                columnNumber: 13
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: "Click wide logo to upload horizontal image."
                            }, void 0, false, {
                                fileName: "[project]/src/app/airline/info/page.tsx",
                                lineNumber: 237,
                                columnNumber: 11
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-xs text-slate-500 mt-1",
                                        children: "This is a full name of your new airline."
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/airline/info/page.tsx",
                                        lineNumber: 252,
                                        columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-xs text-slate-500 mt-1",
                                        children: "This name will be used when the full name is too long to fit."
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/airline/info/page.tsx",
                                        lineNumber: 265,
                                        columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-xs text-slate-500 mt-1",
                                        children: "A short sentence best describing your airline."
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/airline/info/page.tsx",
                                        lineNumber: 278,
                                        columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-xs text-slate-500 mt-1",
                                        children: "ICAO code is your airline designator used for flight numbers."
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/airline/info/page.tsx",
                                        lineNumber: 291,
                                        columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-xs text-slate-500 mt-1",
                                        children: "Start typing airport name, city, or ICAO code (from airline network only)."
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/airline/info/page.tsx",
                                        lineNumber: 303,
                                        columnNumber: 15
            ...
            (airline === null || airline === void 0 ? void 0 : airline.fleets) && airline.fleets.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "space-y-2",
                        children: (_airline_fleets = airline.fleets) === null || _airline_fleets === void 0 ? void 0 : _airline_fleets.map((fleet)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: fleet.fleetAircraftType.icaoCode
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/airline/info/page.tsx",
                                                lineNumber: 325,
                                                columnNumber: 19
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: fleet.fleetAircraftType.name
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/airline/info/page.tsx",
                                                lineNumber: 326,
                                                columnNumber: 19
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                        ...
                        children: "Home Page Description"
                    }, void 0, false, {
                        fileName: "[project]/src/app/airline/info/page.tsx",
                        lineNumber: 340,
                        columnNumber: 9
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "This is what visitors of your airline will see on the home page."
                    }, void 0, false, {
                        fileName: "[project]/src/app/airline/info/page.tsx",
                        lineNumber: 341,
                        columnNumber: 9
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$airline$2f$info$2f$HomePageForm$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].homePageForm,
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("textarea", {
                                placeholder: "Write your home page description here...",
                                rows: 6,
                                className: "".concat(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$airline$2f$info$2f$HomePageForm$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].inputField, " ").concat(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$airline$2f$info$2f$HomePageForm$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].textArea),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-sm text-slate-700 dark:text-slate-300",
                        children: "Here you can close your airline for good. This action is irreversible."
                    }, void 0, false, {
                        fileName: "[project]/src/app/airline/info/page.tsx",
                        lineNumber: 373,
                        columnNumber: 9
            ...
            isMounted && isCloseModalOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$dom$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPortal"])(/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                            ...
                            children: "Confirm Airline Closure"
                        }, void 0, false, {
                            fileName: "[project]/src/app/airline/info/page.tsx",
                            lineNumber: 392,
                            columnNumber: 15
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "text-sm text-slate-700 dark:text-slate-300",
                            children: "Enter your password to verify this irreversible action."
                        }, void 0, false, {
                            fileName: "[project]/src/app/airline/info/page.tsx",
                            lineNumber: 393,
                            columnNumber: 15
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    disabled: closeAirlineMutation.isPending,
                                    children: closeAirlineMutation.isPending ? 'Closing...' : 'Confirm Close'
                                }, void 0, false, {
                                    fileName: "[project]/src/app/airline/info/page.tsx",
                                    lineNumber: 419,
                                    columnNumber: 17
...
_s(AirlineInfoPage, "+9IGj+9R0hgKJG2K3xqpkCILtLA=", false, function() {
    return [
...
_c = AirlineInfoPage;
var _c;
__turbopack_context__.k.register(_c, "AirlineInfoPage");
...
//# sourceMappingURL=_dedc10e4._.js.map