module.exports = [
"[project]/.next-internal/server/app/api/simbrief/submit/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/simbrief/submit/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const outputpageNorm = (outputpage || '').replace('https://', '').replace('http://', '').trim();
        ...
        const apiCode = __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].createHash('md5').update(hashInput).digest('hex');
        ...
        if (session?.user?.id) {
            const pilot = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].pilot.findUnique({
                where: {
            ...
            if (pilot?.airlineId) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$discord$2d$notify$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notifyAirlineFlightPlanFiled"])({
        ...
        console.log('SimBrief Hash Generation:', {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__91550ec2._.js.map